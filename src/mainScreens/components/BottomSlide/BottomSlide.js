...
const BottomSlide = ({ refRBSheet, navigation, handleOpenCamera }) => {
    ...
    const deceaseDetection = async (image) => {
        ...
        formData.append('req_type', "disease");
        ...
        try {
            ...
            if (res) {
                ...
                navigation.navigate("DiseaseResultScreen", { data: res.data, title: "Disease Detection Results", parent: "disease" });
            }
        } catch (err) {
            setLoading(false);
            Alert.alert(
